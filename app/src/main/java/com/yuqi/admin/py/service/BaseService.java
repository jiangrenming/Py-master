...
import com.yuqi.admin.py.activity.LoginActivity;
import com.yuqi.admin.py.base.MyActivityManager;
import com.yuqi.admin.py.base.NoNetworkActivity;
import com.yuqi.admin.py.data.CommonData;
import com.yuqi.admin.py.interfaces.Viewable;
import com.yuqi.admin.py.service.listener.BaseResponseListener;
import com.yuqi.admin.py.service.listener.CacheCommonResultListener;
import com.yuqi.admin.py.service.listener.ResponseListener;
import com.yuqi.admin.py.service.listener.ResultListener;
import com.yuqi.admin.py.utils.Tools;
import com.yuqi.admin.py.utils.cache.CacheHelper;
import com.yuqi.admin.py.utils.config.AppConfig;
...
public abstract class BaseService {
    ...
    protected void get(String url, Map<String, String> params, ResponseListener responseListener){
        ...
        OkGo.get(CommonData.BASE_URL + url).params(params).tag(url).execute(new DefaultJsonObjectCallback(responseListener));
    }
    ...
    protected void postJson(String url, Map<String, Object> params, ResponseListener responseListener){
        ...
        OkGo.post(CommonData.BASE_URL + url + urlParam).upJson(jsonObject).tag(url).execute(new DefaultJsonObjectCallback(responseListener));
    }
    //get没有body 也没有json
