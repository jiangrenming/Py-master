 ...
 *全部地址管理 适配器
 */
public class SpAdapter extends BaseAdapter implements ListAdapter {

    MyPendingPaymentBean mArrayList;
    private Context context;
    private LayoutInflater inflater;

    public SpAdapter(Context context, MyPendingPaymentBean mArrayList) {
        super();
            ...
            http.send(HttpRequest.HttpMethod.POST,
                    ...
                    new RequestCallBack<String>() {
                        ...
                        public void onSuccess(ResponseInfo<String> responseInfo) {
                            ...
                            Bean morendizhi = gson.fromJson(result, Bean.class);
