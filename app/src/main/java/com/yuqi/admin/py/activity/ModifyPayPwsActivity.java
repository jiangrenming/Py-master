...
public class ModifyPayPwsActivity extends BaseActivity {
    ...
    private void init() {
        ...
        countTimer = new ModifyPayPwsActivity.CountTimer(10000, 1000);
    ...
    public void get2CodeClick(View v){
        ...
        if(judge!=true){
            ToastUtil.show(ModifyPayPwsActivity.this, "请填写正确手机号码");
            return ;
        }else {
            countTimer.start();
            ...
            http.send(HttpRequest.HttpMethod.POST,
                    ...
                    params,new RequestCallBack<String>(){
                        ...
                        public void onSuccess(ResponseInfo<String> responseInfo) {
                            ...
                            switch (state) {
                                case "200"://验证码获取成功
                                    ToastUtil.show(ModifyPayPwsActivity.this, "验证码获取成功");
                                    break;
                                case "210"://210:验证码获取失败
                                    ToastUtil.show(ModifyPayPwsActivity.this, "验证码获取失败");
                                    break;
                                case "400":
                                    ToastUtil.show(ModifyPayPwsActivity.this, "账号已存在");
                                    break;
                                case "660"://账号不存在
                                    ToastUtil.show(ModifyPayPwsActivity.this, "账号不存在");
                                    break;
                            }
                        }
                        ...
                        public void onStart() {
                            super.onStart();
                            DialogUtil.start(ModifyPayPwsActivity.this);
                        }
            ...
            case R.id.wjmm_tijiao:
                ...
                if (!StringUtil.isEmpty(mResult)){
                    ...
                    if (judge == true&& wjmm_psw1.getText().toString().equals(wjmm_psw2.getText().toString())==true) {
                        ...
                        ToastUtil.show(ModifyPayPwsActivity.this, "请输入正确的手机号码!");
                        return;
                    }else if(wjmm_psw1.getText().toString().equals(wjmm_psw2.getText().toString())==false){
                        ToastUtil.show(ModifyPayPwsActivity.this, "两次密码不一致!");
                        return;
                    }
...
//                    }
    ...
    private void submit() {
        ...
        http.configCookieStore(My2CookieStore.cookieStore);
        http.send(HttpRequest.HttpMethod.POST,
                CommonData.URL+"forgetPayPassword.action",
                params,
                    ...
                    public void onSuccess(ResponseInfo<String> responseInfo) {
                        ...
                        switch (state){
                            case "200":
                                ...
                                intent.setClass(ModifyPayPwsActivity.this, LoginActivity.class);
                                ToastUtil.show(ModifyPayPwsActivity.this,"修改成功");
                                startActivity(intent);
                                finish();
                                break;
                            case "210":
                                ToastUtil.show(ModifyPayPwsActivity.this,"修改失败");
                                break;
                            case "500":
                                ToastUtil.show(ModifyPayPwsActivity.this,"密码错误");
                                break;
                            case "404":
                                ToastUtil.show(ModifyPayPwsActivity.this,"帐号不存在");
                                break;
                        }
                    }
                    @Override
...
//            btnCaptcha.setText(String.valueOf(time)+"s后重新发送");
            ...
            //给秒数和单位设置蓝色前景色
            ForegroundColorSpan colorSpan = new ForegroundColorSpan(ContextCompat.getColor(ModifyPayPwsActivity.this, android.R.color.holo_blue_dark));
            ...
            btn_captcha_psw.setTextColor(ContextCompat.getColor(ModifyPayPwsActivity.this, android.R.color.black));
        ...
        public void onFinish() {
            Log.e("Tag", "倒计时完成");
            //设置倒计时结束之后的按钮样式
            btn_captcha_psw.setBackgroundColor(ContextCompat.getColor(ModifyPayPwsActivity.this, android.R.color.holo_blue_light));
            btn_captcha_psw.setTextColor(ContextCompat.getColor(ModifyPayPwsActivity.this, android.R.color.white));
